...
import io.spring2go.oneauth.dao.entity.ClientDetailsToScopesXrefEntity;
import io.spring2go.oneauth.dao.entity.RedirectUriEntity;
import io.spring2go.oneauth.dao.repository.ClientDetailsRepository;
import io.spring2go.oneauth.dao.repository.GrantTypeRepository;
import io.spring2go.oneauth.dao.repository.ResourceIdRepository;
import io.spring2go.oneauth.dao.repository.ScopeRepository;
import io.spring2go.oneauth.service.OAuth2DatabaseClientDetailsService;
...
import static io.spring2go.oneauth.webhelper.RedirectMessageHelper.*;
